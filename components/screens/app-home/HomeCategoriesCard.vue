...
<template>
  ...
  >
    ...
    ></NuxtLink>
    <div
      class="relative z-[1] mx-auto flex max-h-[120px] flex-shrink items-center justify-center p-10 md:max-h-[100px]"
    >
      <img
        v-if="props.image"
        :src="props.image"
        alt=""
        class="pointer-events-none block select-none object-contain transition duration-200 group-hover:scale-110"
      />
    </div>
    <div class="relative z-[1] flex-shrink-0">
      <h3
