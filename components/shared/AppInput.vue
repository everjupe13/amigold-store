...
<template>
  <div>
    <div
      class="group flex items-center rounded-[5px] rounded-b-none border border-solid border-black/10 bg-white focus-within:border-green hover:border-green"
    ...
    >
      <div
        class="validation-message rounded-[5px] rounded-t-none bg-green px-20 py-10"
      >
        {{ validationMessage }}
      </div>
    </AppCollapse>
